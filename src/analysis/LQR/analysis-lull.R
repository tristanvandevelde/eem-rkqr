...
write.csv(predictions_model5, "predictions_03_model5.csv", row.names=FALSE)
...
write.csv(predictions_model6, "predictions_03_model6.csv", row.names=FALSE)
...
write.csv(predictions_model7, "predictions_03_model7.csv", row.names=FALSE)
...
write.csv(predictions_model8, "predictions_03_model8.csv", row.names=FALSE)
